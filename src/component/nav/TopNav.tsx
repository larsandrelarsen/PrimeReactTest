  ...
  return (
    <nav className="flex container mx-auto items-center justify-between flex-wrap bg-teal-500 p-6">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center">
        ...
        <div>
          <a href="#"
             className="bg-orange-900 uppercase inline-block text-sm px-4 py-2 leading-none rounded text-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Advertise Area</a>
        </div>
      </div>
    </nav>
  );
